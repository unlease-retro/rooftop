...
const getAdvertGeneric = createSelector( getAll, state => state.getIn(['adverts', 'generic']) )
const getAdvertsChosen = createSelector( getAll, state => state.getIn(['adverts', 'chosen']).toArray() )
...
export default {
  ...
  advertsGeneric: getAdvertGeneric,
  advertsChosen: getAdvertsChosen,
}
