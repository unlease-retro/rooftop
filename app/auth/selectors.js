...
export const getAuthorised = createSelector( getAll, state => state.get('authorised') )
...
export const getRefreshToken = createSelector( getUser, state => state.get('refresh_token') )
