...
export const CHECK_TOKEN_REQUEST = `${name}/CHECK_TOKEN_REQUEST`
export const CHECK_TOKEN_SUCCESS = `${name}/CHECK_TOKEN_SUCCESS`
export const CHECK_TOKEN_FAILURE = `${name}/CHECK_TOKEN_FAILURE`
